    ...
    <div class="max-w-2xl mx-auto bg-bg-dark border border-sienna/30 rounded-2xl p-8 shadow-xl">
        ...
        <form action="{{ route('admin.profile.update') }}" method="POST" class="space-y-6">
            ...
            <div class="flex gap-4 pt-6">
                ...
                <a href="{{ route('admin.dashboard') }}" class="flex-1 px-6 py-3 bg-sienna/20 text-cream-text font-bold rounded-lg border border-sienna/50 hover:bg-sienna/40 transition duration-300 text-center">
